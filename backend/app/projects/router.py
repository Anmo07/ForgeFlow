...
def create_project(data: ProjectCreate, tenant: TenantContext=Depends(require_permission('project:create')), db: Session=Depends(get_db)):
    return service.create_project(db, tenant.organization_id, data, user_id=tenant.user_id)
...
def update_project(project_id: int, data: ProjectUpdate, tenant: TenantContext=Depends(require_permission('project:update')), db: Session=Depends(get_db)):
    return service.update_project(db, project_id, tenant.organization_id, data, user_id=tenant.user_id)
...
def delete_project(project_id: int, tenant: TenantContext=Depends(require_permission('project:delete')), db: Session=Depends(get_db)):
    service.delete_project(db, project_id, tenant.organization_id, user_id=tenant.user_id)
...
def create_task(project_id: int, data: TaskCreate, tenant: TenantContext=Depends(require_permission('project:create')), db: Session=Depends(get_db)):
    return service.create_task(db, project_id, tenant.organization_id, data, user_id=tenant.user_id)
...
def update_task(project_id: int, task_id: int, data: TaskUpdate, tenant: TenantContext=Depends(require_permission('project:update')), db: Session=Depends(get_db)):
    return service.update_task(db, project_id, task_id, tenant.organization_id, data, user_id=tenant.user_id)
...
def delete_task(project_id: int, task_id: int, tenant: TenantContext=Depends(require_permission('project:delete')), db: Session=Depends(get_db)):
    service.delete_task(db, project_id, task_id, tenant.organization_id, user_id=tenant.user_id)

@router.post('/{project_id}/tasks/{task_id}/dependencies/{depends_on_id}', response_model=TaskResponse)
def add_task_dependency(project_id: int, task_id: int, depends_on_id: int, tenant: TenantContext=Depends(require_permission('project:update')), db: Session=Depends(get_db)):
    return service.add_task_dependency(db, project_id, task_id, depends_on_id, tenant.organization_id, user_id=tenant.user_id)