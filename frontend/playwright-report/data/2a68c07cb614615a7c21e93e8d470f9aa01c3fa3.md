...
- complementary:
  - link "ForgeFlow":
    - /url: /dashboard
  - button "E2E Test Org 9126" [expanded]
  - navigation:
    - link "Dashboard":
      - /url: /dashboard
    - link "Projects":
  ...
  - text: T Test Admin e2e_admin_15768@forgeflow.com
  - button "Sign Out"
- main:
  ...
  - paragraph: Manage user invitations, access levels, and active memberships for E2E Test Org 9126.
  - text: Email Address
