...
echo -e " - ${GREEN}Mailpit Web UI:${NC}         http://localhost:8025"
echo -e " - ${GREEN}Mailpit SMTP Port:${NC}      1025"
echo -e " - ${GREEN}PostgreSQL Database:${NC}    localhost:5432 (postgres / postgres)"
echo -e " - ${GREEN}Redis Broker/Cache:${NC}     localhost:6379"
